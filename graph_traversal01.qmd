...
An alternative, when using streaming expressesions is to use the [`fetch`](https://solr.apache.org/guide/solr/latest/query-guide/stream-decorator-reference.html#fetch) stream decorator:
