...
Setup your [Quarto](https://quarto.org/) environment and install some dependencies into your environemnt:
...
Checkout this project and navigate to its root folder. Start the docker instance for Solr as described above, then run `quarto preview` to generate pages and open in a browser. Edits to pages are re-rendered and the browser refreshed on save.
